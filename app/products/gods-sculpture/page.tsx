...
export default function GodsSculpturePage() {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/products?category=gods-sculpture');
  ...
  return (
    <section className="relative glass rounded-2xl p-4 sm:p-8">
      ...
      <p className="mt-2 text-sm sm:text-base text-moss">
        Sacred and spiritual sculptures crafted with precision and devotion.
      </p>
